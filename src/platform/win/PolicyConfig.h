...
// @author EreTIk
// Source: https://github.com/Belphemur/AudioEndPointLibrary (MIT License)
// ----------------------------------------------------------------------------
#pragma once
#include <mmreg.h>
...
// ----------------------------------------------------------------------------
// class CPolicyConfigClient   {870af99c-171d-4f9e-af0d-e63df40c2bc9}
// interface IPolicyConfig     {f8679f50-850a-41cf-9c72-430f290290c8}
...
// Vista 版本备用接口（Win7 优先用上面那个，若 QueryInterface 失败可回退到这个）
...
// ----------------------------------------------------------------------------
// class CPolicyConfigVistaClient  {294935CE-F637-4E7C-A41B-AB255460B862}
// interface IPolicyConfigVista    {568b9108-44bf-40b4-9006-86afe5b5a620}
